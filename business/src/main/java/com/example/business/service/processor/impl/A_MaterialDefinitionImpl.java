...
public class A_MaterialDefinitionImpl implements Processor {
    ...
    public void handle(MsgInfo msgInfo) {
        ...
        List<MaterialDefinitionErp> ErpResponseData = webClientErp.post()
                ...
                .block();
        log.info("物料定义，存货新增 - 根据code请求erp的响应数据：" + ErpResponseData);

        //组装数据
        MaterialDefinitionHeihu data = disposeData(list);
    ...
    private MaterialDefinitionHeihu disposeData(List<MaterialDefinitionErp> list) {
