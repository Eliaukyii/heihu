...
//        saleOrderHeihu.setOwnerCode(data.getAuditor());
        ...
        saleOrderHeihu.setCurrencyCode("CNY");
...
/*            List<CustomFields> customFields2 = items1.getCustomFields();
        ...
        customFields.add(new CustomField("cust_field12__c", phoneNumber));
        customFields.add(new CustomField("cust_field17__c", data.getLinkMan()));
